...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/Pw7Gwsl7W8)
...
```sh
npx nx serve DSGameCloud
```

To create a production bundle:

```sh
npx nx build DSGameCloud
```

To see all available targets to run for a project, run:

```sh
npx nx show project DSGameCloud
```
